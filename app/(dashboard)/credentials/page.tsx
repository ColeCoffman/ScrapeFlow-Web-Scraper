...
import CreateCredentialDialog from "./_credentials/CreateCredentialDialog";
import { formatDistanceToNow } from "date-fns";
import DeleteCredentialDialog from "./_credentials/DeleteCredentialDialog";
    ...
    <div className="flex flex-1 flex-col h-full">
      ...
      <div className="h-full py-6 space-y-8">
        <Alert>
          ...
          <AlertDescription>
            All credentials are encrypted, ensuring your data remains safe and
            secure
          </AlertDescription>
        </Alert>
      </div>
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-1 text-center">
            ...
            <p className="text-muted-foreground text-xs">
              Add a credential below to get started
            </p>
            <CreateCredentialDialog triggerText="Add Credential" />
          </div>
        </div>
      </Card>
    );
